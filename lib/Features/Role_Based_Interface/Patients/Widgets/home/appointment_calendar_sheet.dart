...
class AppointmentCalendarSheet extends StatefulWidget {
  ...
  @override
  State<AppointmentCalendarSheet> createState() =>
...
class _AppointmentCalendarSheetState extends State<AppointmentCalendarSheet> {
  ...
  void initState() {
    ...
    if (widget.appointments.isNotEmpty) {
      ...
      final List<BookedAppointment> upcoming = sortedAll
          ...
          .toList();
      final DateTime initialDate = upcoming.isNotEmpty
          ? upcoming.first.date
          : sortedAll.last.date;
  ...
  Widget build(BuildContext context) {
    ...
    final List<BookedAppointment> selected = _selectedDay == null
        ? const []
