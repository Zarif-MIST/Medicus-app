  ...
  Widget build(BuildContext context) {
    ...
    return DashboardBackGuard(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            // IndexedStack keeps every tab mounted once built, instead of
            // tearing the previous tab's widget (and its State — including
            // whatever it fetched in initState) down and rebuilding it from
            // scratch on every switch, which was flashing each tab blank
            // for a moment while it re-fetched on every single visit.
