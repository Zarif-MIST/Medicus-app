...
class _UploadReportScreenState extends State<UploadReportScreen> {
  ...
  Future<void> _upload() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Report uploaded — your doctor can now see it.'),
        ),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            "This image is too large even after compression — try a clearer, closer photo.",
          ),
        ),
      );
    } catch (e) {
  ...
  void _viewFull(LabReport report) {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => _ReportViewerScreen(report: report)),
    );
  }
            ...
            FutureBuilder<List<LabReport>>(
              ...
              builder: (context, snapshot) {
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) => _ReportThumbnail(
                    report: reports[index],
                    onTap: () => _viewFull(reports[index]),
                  ),
                );
              },
            ),
