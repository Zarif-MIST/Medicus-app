      ...
      build: (context) {
        return pw.Column(
          ...
          children: [
            ...
            pw.Text(
              'Present the QR code above at the pharmacy counter to collect this medicine.',
              style: const pw.TextStyle(fontSize: 9, color: PdfColors.grey700, fontWeight: pw.FontWeight.bold),
            ),
            pw.SizedBox(height: 4),
            pw.Text(
