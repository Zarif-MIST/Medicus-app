...
class _PatientSearchScreenState extends State<PatientSearchScreen> {
  ...
  static const PharmacyRegistryService _pharmacyService =
            ...
            children: [
              ...
              Expanded(
                child: !hasQuery
                    ? _EmptyHint(
                        text:
                            'Search for a doctor, specialty, medicine, pharmacy, hospital, or one of your own appointments.',
                      )
                    : !hasResults
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            onPressed: onCall,
            icon: const Icon(Icons.call_outlined, color: MColors.primaryColor),
          ),
        ],
      ),
    );
