          ...
          children: [
            ...
            _NavCard(
              ...
              onTap: () => Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (_) =>
                      RecordsScreen(prescriptions: widget.prescriptions),
                ),
              ),
            ),
            SizedBox(height: pad * 0.6),
...
class _PatientQrCard extends StatelessWidget {
  const _PatientQrCard({required this.patientId, required this.patientName});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Patient QR', style: theme.textTheme.titleMedium),
        const SizedBox(height: 10),
        Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Show this code when a doctor, pharmacist, or lab specialist needs your record.',
