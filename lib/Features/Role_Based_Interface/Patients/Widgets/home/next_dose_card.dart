...
class _NextDoseCardState extends State<NextDoseCard> {
  ...
  bool _isOverlapping(ScheduledDose dose) =>
      overlappingDoseKeys(_todaysDoses).contains(dose.overlapKey);
  ...
  Widget build(BuildContext context) {
    ...
    final int snoozeMinutesLeft = isSnoozed
        ? log!.snoozeUntil!.difference(DateTime.now()).inMinutes.clamp(0, 999)
        : 0;
