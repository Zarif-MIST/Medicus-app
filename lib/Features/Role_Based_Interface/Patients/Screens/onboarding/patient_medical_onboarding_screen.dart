...
class PatientMedicalOnboardingScreen extends StatefulWidget {
  ...
  @override
  State<PatientMedicalOnboardingScreen> createState() =>
      _PatientMedicalOnboardingScreenState();
}

class _PatientMedicalOnboardingScreenState
    extends State<PatientMedicalOnboardingScreen> {
  ...
  void _continueToDashboard() {
    Get.offAll(
      () => PatientDashboardScreen(account: widget.account),
